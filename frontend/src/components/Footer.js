    ...
    <footer className="relative bg-surface/40 backdrop-blur-md border-t border-border mt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 text-center relative z-10">
        <div className="flex justify-center space-x-8 mb-6">
          ...
          <a href="/services" className="text-text-muted hover:text-foreground dark:hover:text-white dark:hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all font-medium">
            {t("footer_services")}
          </a>
          <a href="/auth/login" className="text-text-muted hover:text-foreground dark:hover:text-white dark:hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all font-medium">
            {t("footer_login")}
          </a>
          <a href="/auth/register" className="text-text-muted hover:text-foreground dark:hover:text-white dark:hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all font-medium">
            {t("footer_register")}
          </a>
        </div>
