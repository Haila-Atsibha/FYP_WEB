...
export default function Modal({ isOpen, onClose, children }) {
  ...
  return (
    <div className="fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-all duration-300">
      <div className="bg-surface border border-border rounded-3xl shadow-2xl p-8 max-w-md w-full relative active:scale-[0.99] transition-transform max-h-[90vh] overflow-y-auto">
        <button
